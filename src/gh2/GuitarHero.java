...
public class GuitarHero {
    ...
    private static final Deque<GuitarString> reference = new ArrayDeque<>();
    private static Deque<GuitarString> played = new ArrayDeque<>();
    public static void main(String[] args) {
        for (int i = 0; i < 37; i++) {
            double freq = 440.0 * Math.pow(2.0, (i - 24.0) / 12.0);
            reference.addLast(new GuitarString(freq));
        }
